...
function newBall(mainCF)
   ...
   while wait() do
      ...
      weld.C0 = weld.C0:Lerp(mainCF * CFrame.new(0, sin/7, sin/14) * CFrame.Angles(math.clamp(sin, -2, 0.4)/10,0,0),0.2)
...
local up = torso.Name == "Torso" and -.2 or -.1
